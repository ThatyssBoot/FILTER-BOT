...
PICS = (environ.get('PICS', 'https://graph.org/file/ce19da10ef508579a5b7b-2a438a33a8cf9a9e9e.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002273237825') # give your force subscribe channel id here else leave it blank
