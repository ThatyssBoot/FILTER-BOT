...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1786851907 6272165202').split()] # 6272165202 For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002560922742') # -1002401476409 -1002392888253 give your force subscribe channel id here else leave it blank
